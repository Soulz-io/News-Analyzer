...
SOURCE_CREDIBILITY: Dict[str, float] = {
    ...
    # Expansion accounts (geopolitiek + markets + macro)
    "X/Twitter - @WarMonitors": 0.72,
    "X/Twitter - @detresfa_": 0.78,
    "X/Twitter - @Osint613": 0.72,
    "X/Twitter - @ianbremmer": 0.85,
    "X/Twitter - @Tatarigami_UA": 0.75,
    "X/Twitter - @calibreobscura": 0.74,
    "X/Twitter - @War_Monitoring": 0.68,
    "X/Twitter - @LizAnnSonders": 0.82,
    "X/Twitter - @charliebilello": 0.80,
    "X/Twitter - @elerianm": 0.85,
    "X/Twitter - @Natsecjeff": 0.72,
    "X/Twitter - @LongWarJournal": 0.80,
    "X/Twitter - @Mr_Andrew_Fox": 0.70,
    "X/Twitter - @DD_Geopolitics": 0.72,
    "X/Twitter - @GeoPWatch": 0.70,
    "X/Twitter - @InsightGL": 0.68,
    "X/Twitter - @GIS_Reports": 0.78,
    "X/Twitter - @Overton_news": 0.65,
    "X/Twitter - @weewoono": 0.65,
    "X/Twitter - @HelenHet20": 0.78,
    "X/Twitter - @bespokeinvest": 0.80,
    "X/Twitter - @JustinWolfers": 0.78,
    "X/Twitter - @Steve_Hanke": 0.75,
    "X/Twitter - @AswathDamodaran": 0.85,
    "X/Twitter - @WSJmarkets": 0.88,
    "X/Twitter - @RayDalio": 0.82,
    "X/Twitter - @paulkrugman": 0.75,
    "X/Twitter - @TheEconomist": 0.85,
    "X/Twitter - @YardeniResearch": 0.80,
    "X/Twitter - @GoldmanSachs": 0.82,
    "X/Twitter - @CNBC": 0.72,
    "X/Twitter - @MarketWatch": 0.72,
    "X/Twitter - @Nasdaq": 0.80,
    "X/Twitter - @morganhousel": 0.78,
    "X/Twitter - @BrianFeroldi": 0.72,
    "X/Twitter - @awealthofcs": 0.78,
    "X/Twitter - @Trader_Dante": 0.65,
    "X/Twitter - @DeepakShenoy": 0.70,
    "X/Twitter - @AndrewLokenauth": 0.65,
    "X/Twitter - @IanCassel": 0.70,
    "X/Twitter - @PrometheanActn": 0.60,
    "X/Twitter - @elitepredatorss": 0.58,
    "X/Twitter - @alpha_defense": 0.62,
    "X/Twitter - @BharatAlphaint": 0.58,
    "X/Twitter - @NoLimitGains": 0.68,
    "X/Twitter - @QuiverQuant": 0.82,
    "X/Twitter - @unusual_whales": 0.78,
    "X/Twitter - @DeItaone": 0.85,
    "X/Twitter - @BNONews": 0.80,
    "X/Twitter - @FirstSquawk": 0.76,
    "X/Twitter - @Fxhedgers": 0.68,
    "X/Twitter - @Insider_Trades": 0.75,
    "X/Twitter - @IABOROWITZ": 0.82,
    "X/Twitter - @ABOROWITZ": 0.80,
    "X/Twitter - @ICG_Updates": 0.82,
    "X/Twitter - @DefenseIntel": 0.75,
}
